...
namespace AlGallery.Migrations
{
    ...
    partial class AlGalleryDBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlGallery.Models.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlGallery.Models.User", b =>
                {
            ...
            modelBuilder.Entity("AlGallery.Models.CartItems", b =>
                {
                    b.HasOne("AlGallery.Models.User", "Customers")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AlGallery.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
